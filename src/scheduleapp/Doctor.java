...
public class Doctor {   
    ...
    private Patient[] patientArray; // Doctor Patient List
    ...
    // Add a patient List []
    public void addPatientList(Patient[] arrayPat){
        patientArray = arrayPat;        
        
    }
    // Add one patient to List[]
    public void addPatientToList(Patient obj,Patient[] arrayPat){
        int temp = arrayPat.length;
        Patient[] tempArray = new Patient[temp+ 1];
        tempArray = arrayPat;
        // work here
        patientCount = patientArray.length;
        patientArray[patientCount] = obj;
        patientCount++; 
    ...
    public void addSchduleToArray(Schedule obj){
